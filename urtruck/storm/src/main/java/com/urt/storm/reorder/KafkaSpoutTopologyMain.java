...
import com.urt.storm.apiMsgLog.ApiMsgBolt;
import com.urt.storm.batchUpdate.card.TestTopicTupleBuilder;

public class KafkaSpoutTopologyMain {
    private static final String STREAMS = "reorder_stream";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new ReorderBolt()).shuffleGrouping("kafka_spout", STREAMS);
...
//        props.put(KafkaSpoutConfig.Consumer.ENABLE_AUTO_COMMIT, "true");
    ...
    public static KafkaSpoutStreams getKafkaSpoutStreams() {
        final Fields outputFields = new Fields("value","topic", "partition", "offset", "key");
