...
public class BatchFtpImportKafkaSpoutTopology {
	//汇报offset信息的root路径
		private static final String offsetZkRoot = "/archiveZkRoot";
	    //存储该spout id的消费offset信息,譬如以topoName来命名
		private static final String offsetZkId = "batchFtpImportProducer";
		//topicName
	    ...
	    public static StormTopology getTopolgyKafkaSpout() {
	        ...
	        tBuilder.setSpout("batchFtpImportTotalSpout", new KafkaSpout(getSpoutConfig()), 3);
	        tBuilder.setBolt("batchFtpImportTotalBolt", new BatchFtpImportBolt(),15).setNumTasks(10).shuffleGrouping("batchFtpImportTotalSpout");
