...
public class BatchFtpImportKafkaSpoutTopologyMain {
    private static final String STREAMS = "batchFtpImport_state_stream";
    private static final String TOPICS = "batchFtpImportProducer";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new BatchFtpImportBolt()).shuffleGrouping("kafka_spout", STREAMS);
