...
public class UserInfoSpoutAndTopo {

	//汇报offset信息的root路径
	private static final String offsetZkRoot = "/archiveZkRoot";
    //存储该spout id的消费offset信息,譬如以topoName来命名
	private static final String offsetZkId = "cardInfoProducer";
	//topicName
    private static final String TOPICS = "cardInfoProducer";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
        ...
        tBuilder.setBolt("archiveTotalBolt", new UserInfoBolt()).shuffleGrouping("archiveTotalSpout");
