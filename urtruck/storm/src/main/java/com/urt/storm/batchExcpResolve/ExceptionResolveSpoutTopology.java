...
public class ExceptionResolveSpoutTopology {
	//汇报offset信息的root路径
		private static final String offsetZkRoot = "/archiveZkRoot";
	    //存储该spout id的消费offset信息,譬如以topoName来命名
		private static final String offsetZkId = "exceptionResProducer";
		//topicName
	    private static final String TOPICS = "exceptionResProducer";
	    ...
	    public static StormTopology getTopolgyKafkaSpout() {
	        ...
	        tBuilder.setSpout("archiveTotalSpout", new KafkaSpout(getSpoutConfig()), 1);
	        tBuilder.setBolt("archiveTotalBolt", new ExceptionResolveTaskBolt()).shuffleGrouping("archiveTotalSpout");
