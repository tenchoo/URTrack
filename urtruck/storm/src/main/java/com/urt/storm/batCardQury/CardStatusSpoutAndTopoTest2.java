...
public class CardStatusSpoutAndTopoTest2 {
    ...
    public static StormTopology getTopolgyKafkaSpout() {
        ...
        tBuilder.setBolt("archiveTotalBolt", new CardStatusBoltTest()).shuffleGrouping("archiveTotalSpout");
