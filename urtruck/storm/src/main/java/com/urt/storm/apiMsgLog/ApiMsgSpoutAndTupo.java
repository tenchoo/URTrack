...
public class ApiMsgSpoutAndTupo {
	// 汇报offset信息的root路径
	private static final String offsetZkRoot = "/archiveZkRoot";
	// 存储该spout id的消费offset信息,譬如以topoName来命名
	private static final String offsetZkId = "apiMsgToppic";
	// topicName
	private static final String TOPICS = "apiMsgToppic";
	...
	public static StormTopology getTopolgyKafkaSpout() {
		...
		tBuilder.setSpout("apiMsgSpout",
				new KafkaSpout(getSpoutConfig()), 3);
		tBuilder.setBolt("apiMsgBolt", new ApiMsgBolt(), 15)
				.setNumTasks(10).shuffleGrouping("apiMsgSpout");
