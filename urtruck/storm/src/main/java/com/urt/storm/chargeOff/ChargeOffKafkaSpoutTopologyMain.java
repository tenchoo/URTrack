...
public class ChargeOffKafkaSpoutTopologyMain {
	//汇报offset信息的root路径
		private static final String offsetZkRoot = "/archiveZkRoot";
	    //存储该spout id的消费offset信息,譬如以topoName来命名
		private static final String offsetZkId = "chargeoff_stream";
		//topicName
	    private static final String TOPICS = "chargeOffTopic";
	    ...
	    public static StormTopology getTopolgyKafkaSpout() {
	        ...
	        tBuilder.setSpout("chargeOffSpout", new KafkaSpout(getSpoutConfig()),2);
	        tBuilder.setBolt("chargeOffBolt", new ChargeOffBolt(),4).shuffleGrouping("chargeOffSpout");
