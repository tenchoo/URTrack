...
public class QueryTrafficKafkaSpoutTopologyMain {
    private static final String STREAMS = "queryTraffic_state_stream";
    private static final String TOPICS = "queryTrafficProducer";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new QueryTrafficBolt()).shuffleGrouping("kafka_spout", STREAMS);
