...
public class ChargeOffKafkaSpoutTopology {
    private static final String STREAMS = "chargeoff_stream";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new ChargeOffBolt()).shuffleGrouping("kafka_spout", STREAMS);
