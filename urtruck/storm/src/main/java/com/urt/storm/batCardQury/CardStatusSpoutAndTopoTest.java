 ...
 * 类说明：归档storm
 * @author fuhp
 * @date 2016年5月26日 下午7:38:40
 */
public class CardStatusSpoutAndTopoTest {
	//汇报offset信息的root路径
	private static final String offsetZkRoot = "/cardStatusZkRoot";
    //存储该spout id的消费offset信息,譬如以topoName来命名
	private static final String offsetZkId = "cardStatuslZkId";
	//topicName
    private static final String TOPICS = "cardStatusTopic";
    ...
    protected static void submitTopologyLocalCluster(StormTopology topology, Config config) throws InterruptedException {
        ...
        cluster.submitTopology("cardStatusTopo", config, topology);
        stopWaitingForInput();
    }
    ...
    public static StormTopology getTopolgyKafkaSpout() {
        ...
        tBuilder.setSpout("cardStatusSpout", new KafkaSpout(getSpoutConfig()), 1);
        tBuilder.setBolt("cardStatusBolt", new CardStatusBoltTest()).shuffleGrouping("cardStatusSpout");
