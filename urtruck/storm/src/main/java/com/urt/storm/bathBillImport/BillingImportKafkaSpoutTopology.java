...
public class BillingImportKafkaSpoutTopology {
    private static final String STREAMS = "billingImport_stream";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new BillingImportBolt()).shuffleGrouping("kafka_spout", STREAMS);
