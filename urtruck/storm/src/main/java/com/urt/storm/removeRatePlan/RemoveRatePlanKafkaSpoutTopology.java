...
public class RemoveRatePlanKafkaSpoutTopology {
    private static final String STREAMS = "Remove_Rate_Plan_stream";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new RemoveRatePlanBolt()).shuffleGrouping("kafka_spout", STREAMS);
