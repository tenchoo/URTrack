...
public class LbsQueryLocationKafkaSpoutTopology {
	//汇报offset信息的root路径
		private static final String offsetZkRoot = "/archiveZkRoot";
	    //存储该spout id的消费offset信息,譬如以topoName来命名
		private static final String offsetZkId = "lbsQueryLocationProducer";
		//topicName
	    private static final String TOPICS = "lbsQueryLocationProducer";
	    ...
	    static{
	        ...
	        try {
	            ...
	            System.out.println("offsetZkPort:"+offsetZkPort);
	            String offsetZkServers = prop.getProperty("offsetZkServers").trim();
	            System.out.println("offsetZkServers:"+offsetZkServers);
	            ...
	            System.out.println("serializerClass:"+serializerClass);
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
	    }
	    ...
	    public static void main(String[] args) throws Exception {
	    	System.out.println("begin LbsQueryLocationKafkaSpoutTopology ..........");
	    ...
	    public static SpoutConfig getSpoutConfig(){
	    	System.out.println("begin getSpoutConfig ..........");
	    	// 配置Zookeeper地址
	        BrokerHosts brokerHosts = new ZkHosts(host);
	        System.out.println("begin getSpoutConfig host.........."+host);
			...
			try {
				...
				System.out.println("begin getSpoutConfig stat.........."+stat);
				 //if(stat == null){
	    ...
	    public static StormTopology getTopolgyKafkaSpout() {
	    	System.out.println("begin getTopolgyKafkaSpout ..........");
	    	final TopologyBuilder tBuilder = new TopologyBuilder();
	    	tBuilder.setSpout("lbsQueryLocationSpout", new KafkaSpout(getSpoutConfig()), 3);
	        tBuilder.setBolt("lbsQueryLocationBolt", new LbsQueryLocationBolt(),15).setNumTasks(10).shuffleGrouping("lbsQueryLocationSpout");
