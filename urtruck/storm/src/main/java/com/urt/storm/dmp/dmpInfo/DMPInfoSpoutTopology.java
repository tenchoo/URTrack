...
public class DMPInfoSpoutTopology {
	//汇报offset信息的root路径
		private static final String offsetZkRoot = "/archiveZkRoot";
	    //存储该spout id的消费offset信息,譬如以topoName来命名
		private static final String offsetZkId = "DeviceData2";
		//topicName
	    private static final String TOPICS = "DeviceData2";
...
//	    protected static void submitTopologyRemoteCluster(String arg, StormTopology topology, Config config)
//	    	    throws Exception
//	    	  {
//	    	    config.setNumWorkers(3);
//
...
//	        tBuilder.setSpout("dmpInfoTotalSpout", new KafkaSpout(getSpoutConfig()), 3);
//	        tBuilder.setBolt("dmpInfoTotalBolt", new DMPInfoBoltI(),15).setNumTasks(10).shuffleGrouping("dmpInfoTotalSpout");
//	        return tBuilder.createTopology();
//	    }
	    public static StormTopology getTopolgyKafkaSpout()
	    {
	      TopologyBuilder tBuilder = new TopologyBuilder();
	      tBuilder.setSpout("dmpInfoTotalSpout", new KafkaSpout(getSpoutConfig()));
	      tBuilder.setBolt("dmpInfoTotalBolt", new DMPInfoBoltI()).shuffleGrouping("dmpInfoTotalSpout");
	      return tBuilder.createTopology();
	    }
}
