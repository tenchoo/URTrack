...
public class SendMsgKafkaSpoutTopologyMain {
    private static final String STREAMS = "sendMsg_ByColony_stream";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new SendMsgByColonyBolt()).shuffleGrouping("kafka_spout", STREAMS);
