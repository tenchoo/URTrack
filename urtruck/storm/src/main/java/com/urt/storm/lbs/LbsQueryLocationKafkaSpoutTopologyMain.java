...
import com.urt.storm.util.TopicTupleBuilder;
...
public class LbsQueryLocationKafkaSpoutTopologyMain {
    private static final String STREAMS = "lbsQueryLocation_state_stream";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new LbsQueryLocationBolt()).shuffleGrouping("kafka_spout", STREAMS);
...
//        props.put(KafkaSpoutConfig.Consumer.ENABLE_AUTO_COMMIT, "true");
        props.put(KafkaSpoutConfig.Consumer.BOOTSTRAP_SERVERS, "172.17.201.80:9092");
    ...
    public static KafkaSpoutTuplesBuilder<String, String> getTuplesBuilder() {
        return new KafkaSpoutTuplesBuilder.Builder<>(
                 new TopicTupleBuilder<String, String>(TOPICS))
                .build();
    }

    public static KafkaSpoutStreams getKafkaSpoutStreams() {
        final Fields outputFields = new Fields("value", "partition", "offset", "key", "topic");
