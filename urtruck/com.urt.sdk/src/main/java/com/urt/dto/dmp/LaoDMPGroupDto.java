...
public class LaoDMPGroupDto implements Serializable {
    private Long id;
	...
	public String toString() {
		return "LaoDMPGroupDto [id=" + id + ", groupName=" + groupName
				+ ", groupComment=" + groupComment + ", channelCustid="
				+ channelCustid + ", delflag=" + delflag + ", createtime="
