package com.urt.dto.report;

import java.io.Serializable;
import java.util.Date;

public class LaoReptInfoDto implements Serializable {
	private Long reptId;
	...
	public String toString() {
		return "LaoReptInfoDto [reptId=" + reptId + ", tradeTypeCode="
				+ tradeTypeCode + ", reptName=" + reptName + ", displayInfo="
				+ displayInfo + ", colIds=" + colIds + ", colAttr=" + colAttr
				+ ", sqlInfo=" + sqlInfo + ", condCols=" + condCols
				+ ", condSource=" + condSource + ", displayType=" + displayType
				+ ", validTag=" + validTag + ", recvTime=" + recvTime
