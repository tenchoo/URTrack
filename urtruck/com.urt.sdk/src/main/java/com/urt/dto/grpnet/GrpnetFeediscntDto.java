...
public class GrpnetFeediscntDto implements Serializable {
	...
	public void setDiviedChildValue(String diviedChildValue) {
		this.diviedChildValue = diviedChildValue == null ? null
				: diviedChildValue.trim();
	}
	...
	public void setDiviedParentValue(String diviedParentValue) {
		this.diviedParentValue = diviedParentValue == null ? null
				: diviedParentValue.trim();
	}
