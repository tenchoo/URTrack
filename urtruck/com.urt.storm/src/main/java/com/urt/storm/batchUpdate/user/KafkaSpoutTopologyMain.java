...
public class KafkaSpoutTopologyMain {
    private static final String STREAMS = "user_info_stream";
    private static final String TOPICS = "userInfoProducer";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
      ...
      //  tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        tp.setBolt("kafka_bolt_1", new UserInfoBolt()).shuffleGrouping("kafka_spout", STREAMS);
