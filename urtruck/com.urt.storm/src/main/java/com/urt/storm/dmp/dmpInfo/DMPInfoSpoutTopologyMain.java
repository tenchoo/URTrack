...
public class DMPInfoSpoutTopologyMain {
    private static final String STREAMS = "DeviceData";
    private static final String TOPICS = "DeviceData";
    ...
    public static StormTopology getTopolgyKafkaSpout() {
        ...
        tp.setBolt("kafka_bolt_1", new DMPInfoBoltI()).shuffleGrouping("kafka_spout", STREAMS);
