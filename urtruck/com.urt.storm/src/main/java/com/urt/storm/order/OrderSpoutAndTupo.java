...
public class OrderSpoutAndTupo {
	// 汇报offset信息的root路径
	private static final String offsetZkRoot = "/archiveZkRoot";
	// 存储该spout id的消费offset信息,譬如以topoName来命名
	private static final String offsetZkId = "orderToppic";
	// topicName
	private static final String TOPICS = "orderToppic";
	...
	public static StormTopology getTopolgyKafkaSpout() {
		...
		tBuilder.setSpout("orderSpout",
				new KafkaSpout(getSpoutConfig()), 3);
		tBuilder.setBolt("orderBolt", new OrderBolt(), 15)
				.setNumTasks(10).shuffleGrouping("orderSpout");
