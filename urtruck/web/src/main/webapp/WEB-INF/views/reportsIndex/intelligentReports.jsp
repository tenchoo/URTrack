...
<html>
<head>
<title><fmt:message bundle='${pageScope.bundle}'  key='Intelligent.consumer.electronic.report.query' /></title>
<base href="<%=basePath%>" />
<!-- css -->
...
/* 	$(function() {
		$.ajax({
			url:"intelligent/intelligentReport",
			data:{},
			success:function(result){
				$("#reptId").val(result[0].id);
			}
		})
	}) */
	$(function() {
...
<!-- 加载内容放这里 -->
            <div class="tableBox">
               ...
               <div class="tableTit">
                     	<fmt:message bundle='${pageScope.bundle}'  key='Intelligent.consumer.electronic.report.query' />
                </div>
             <table class="overflow-y" id="idData">
             <thead>
             		<tr>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='package.type' /></th>
