    ...
    <script>
    		$(function(){
    			$("#chargeRecord").click(function(){
    				...
    				$("#submitForm").attr("action","queryService/queryChargeRecord");
    			});
    			$("#purchaseHistory").click(function(){
    				$('.nav li').removeClass('live');
    				$(this).parent().addClass('live')
    				$("#submitForm").attr("action","queryService/queryPurchaseHistory");
    			});
    		});
    </script>
</head>
			...
			<div class="tab-content">
				<div
					...
					<div
						...
						class="row">
						<form action="queryService/queryChargeRecord" method="post" id="submitForm">
							<div
						...
						<div style="text-align: center;" class="row">
							...
							<button
								...
								type="button" class="btn" onclick="$('#submitForm').submit()"><fmt:message bundle='${pageScope.bundle}'  key='Query' /></button>
