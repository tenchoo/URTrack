...
<body>
    ...
    <div class="header">
        <div class="centerBox">
            ...
            <dl class="nav">
                <dt class="current"><a href="${ctx}/customerQuery/loginSuccessIndex" id="shouYe"><fmt:message bundle='${pageScope.bundle}'  key='home.page' /></a></dt>
                ...
                <dd class="flow hide" >
                	<a href=""><fmt:message bundle='${pageScope.bundle}'  key='Device.activation' /></a>
                ...
                <ul class="starProSlide">
                    <li>
                        ...
                        <a href="javascript:;">
                            ...
                            <span class="text03">下单即送游戏键鼠套装</span>
                        ...
                        <a href="javascript:;">
                            ...
                            <span class="text02">ThinkPad 黑将S5</span>
                            <span class="text03">黑将临世生为竞技</span>
                        ...
                        <a href="javascript:;">
                            ...
                            <span class="text02"><fmt:message bundle='${pageScope.bundle}'  key='Lenovo.Ideapad' />Air13ProI5window</span>
                            <span class="text03">4G大显存升级固态硬盘</span>
                        ...
                        <a href="javascript:;">
                            ...
                            <span class="text01"><b><fmt:message bundle='${pageScope.bundle}'  key='Portable.MIFI' /></b></span>
                            <span class="text02">ZUKZ2Pro 尊享版</span>
                            <span class="text03"><fmt:message bundle='${pageScope.bundle}'  key='purchase.a.mobile.phone.to.get.a.free.bag' /></span>
