...
<body>
	<div class="pd-20">
	<form role="form"  method="post" enctype="multipart/form-data" id="cform" action="<%=request.getContextPath() %>/rateSearch/batchImport">
	    <div class="cl pd-5 mt-10" >
			<label for="name"><fmt:message bundle='${pageScope.bundle}'  key='Import.batch.operation.files' />：</label>
	      	<input type="file" class="input-text" style="width:250px;padding-bottom:35px;" id="inputfile" name="file">
     		<input type="submit" class='btn btn-primary radius' value="<fmt:message bundle='${pageScope.bundle}'  key='Submit' />"/>
 		</div>
	</form>
	</div>
</body>
