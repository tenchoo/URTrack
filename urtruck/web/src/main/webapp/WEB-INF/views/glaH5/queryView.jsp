...
<link rel="stylesheet" href="static/h5/css/normalize.css">
<link rel="stylesheet" href="static/h5/css/stylesheet.css">
...
<script type="text/javascript">
	$(function() {
					...
					var jsonObj = eval("(" + data + ")");
                      ...
                      switch (statusCode) {
                          ...
                          case -9:
                              ...
                              break;
                          case -10:
                        	  alert("<fmt:message bundle='${pageScope.bundle}'  key='This.user.has.no.permission.to.operate.iccid' />");
                              break;
                          case -11:
                        	  alert("<fmt:message bundle='${pageScope.bundle}'  key='The.iccid.is.not.exist.in.the.system' />");
                              break;
                      }
					layer.close(msg);
				},
		...
		$("#iccid").change(function(){
			...
			if (iccid != '' && iccid != null && iccid.length == 20) {
				var data1 = {
						'iccid' : iccid
					};
					request(data1);
...
<body>
    ...
    background-image: linear-gradient(to bottom,#f9d38f 0,#f98333 100%);" >
		...
		<nav style="text-shadow: none; background:rgba(255,00,255,0); border:none;margin-bottom: 0vw" class="navbar navbar-default">
            ...
            <div style=" background:rgba(255,00,255,0);margin: 0em" class="navbar-header ">
                ...
                <a class="navbar-brand" style="padding-top: 0px" href="<%=basePath%>glaH5App/index"><img src="static/h5/images/logo5.png" style="height: 2.2rem;margin-top:0.5rem;"></a>
            ...
            <div  style="border-bottom: none;background-color: #FFFFFF; font-family:微软雅黑;" class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
                <ul style="margin: 1.5rem 1rem;text-align: left" class="nav navbar-nav  ">
                  <%--   <li style="text-align: left" >
                    ...
                    padding-left: 4rem" class="wow fadeInDownBig animated " href="<%=basePath%>glaH5App/index">首页
                        </a> </li> --%>
                    ...
                    <%-- <li class="dropdown">
                        ...
                        <ul style="margin: auto 1rem;" class="dropdown-menu">
                            <li><a class="wow fadeIn animated" style="font-size: 3.8vw;text-align: left;padding-left: 3rem" href="<%=basePath%>glaH5AppActive/index">激活</a></li>
                            <li role="separator" class="divider"></li>

                            <li><a class="wow fadeIn animated" style="font-size: 3.8vw;text-align: left;padding-left: 3rem" href="<%=basePath%>glaH5App/productIntroduce">介绍</a></li>
                            <li role="separator" class="divider"></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul style="margin: auto 1rem;" class="dropdown-menu ">
                            <li><a class="wow fadeIn animated" style="font-size: 3.8vw;text-align: left;padding-left: 3rem" href="<%=basePath%>glaH5AppPay/toChargeView"><fmt:message bundle='${pageScope.bundle}'  key='recharge' /></a></li>
                            <li role="separator" class="divider"></li>
                            <li><a class="wow fadeIn animated" style="font-size: 3.8vw;text-align: left;padding-left: 3rem"  href="<%=basePath%>glaH5AppQuery/index"><fmt:message bundle='${pageScope.bundle}'  key='Query' /></a></li>
                            <li role="separator" class="divider"></li>
				...
				<ul style="margin: auto 1rem;" class="nav navbar-nav navbar-right ">
					<%
							if (session.getAttribute("lenovoid") != null && session.getAttribute("lenovoid") != "") {
							%>
                            <li class="dropdown">
		                        <a style="margin: 0.5rem 0;padding-top:0;padding-bottom:2rem;animation-delay:0s; animation-name: fadeInDownBig;text-align: left;padding-left: 4rem" href="javascript:WeixinJSBridge.call('closeWindow');" class="wow fadeInDownBig animated dropdown-toggle" >
							...
							%>
							<li class="dropdown">
		                        <a style="margin: 0.5rem 0;padding-top:0;padding-bottom:2rem;animation-delay:0s; animation-name: fadeInDownBig;text-align: left;padding-left: 4rem" href="<%=session.getAttribute("bindurl")%>" class="wow fadeInDownBig animated dropdown-toggle" >
                ...
                <%-- <ul style="margin: auto 1rem;" class="nav navbar-nav navbar-right ">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a  class="wow fadeIn animated" style="font-size: 3.8vw; animation-delay: 0.01s; animation-name: fadeInDownBig;text-align: left;padding-left: 12rem" href="<%=basePath%>glaH5App/loginout">退出</a></li>
		...
		<div style="margin: 5vw 0;" class="row">
			...
			<div class="col-xs-12">
				<div>
					...
					<select style="color: #000;float:right" id="iccid" name="iccid"  placeholder="<fmt:message bundle='${pageScope.bundle}'  key='Please.choose' />">
		...
		<div
			...
			<div style="text-align: center; margin-left: 8vw; margin-top: 1rem; padding-left: 0px; padding-bottom: 0"
				...
				<p style="font-size: 9vw; margin-top: 0rem; margin-left: 0">
					<span id="dataRemaining">0</span><span style="font-size: 3.8vw;">M</span>
				</p>
				<!-- <p style="font-size: 3.8vw; margin-top: 0.5rem">
					流量包：<span id="useing">0</span>%
				</p> -->
		...
		<div style="color: #fff; margin-top: 4rem; padding-bottom: 1rem;width:100vm;padding-left:0;padding-right:0;"
			...
			<div style="text-align: center; padding-right: 0; padding-left: 20px"
				...
				<p
					...
					<span id="useing">0</span><fmt:message bundle='${pageScope.bundle}'  key='data.plan' />
				</p>
	...
	<div
		...
		<div style="margin:0rem;" class="row">
			...
			<div
				...
				class="col-xs-6">
				<a href="javascript:void(0)" onclick="if($('#iccid').find('option:selected').val().length == 20){javascript:window.location.href='<%=basePath%>glaH5AppQuery/queryRecord'}else{alert('<fmt:message bundle="${pageScope.bundle}"  key="Please.choose" /> ICCID')} "> <img class="img-circle" src="static/h5/images/charge.png"
					style="width: 15vw">
				</a>
			...
			<div
				...
				class="col-xs-6">
				<a href="javascript:void(0)" onclick="if($('#iccid').find('option:selected').val().length == 20){javascript:window.location.href='<%=basePath%>glaH5AppQuery/queryRecord'}else{alert('<fmt:message bundle="${pageScope.bundle}"  key="Please.choose" /> ICCID')} ">
	...
	<div style="text-align: center; padding:; width: 100%"
		...
		<button
			...
			type="button" class="btn " onclick="window.location.href='/glaH5AppPay/toChargeView'"><fmt:message bundle='${pageScope.bundle}'  key='Instant.recharge' /></button>
	</div>
	</nav>
	<div>
</body>
