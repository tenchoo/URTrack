	...
	<div style="background-color: #f4f3f9; font-size: 3.8vw; overflow:hidden;">
		...
		<div
			...
			<div
				...
				class="row">
				<div class="col-xs-4">
					<p style="margin-top: 1.8rem; margin-left: 1.5rem;"><fmt:message bundle='${pageScope.bundle}'  key='Order.information' /></p>
				</div>
				<div class="col-xs-8">
					<p style="font-size: 3.4vw; margin-top: 2rem;padding-bottom:20px;">ICCID：${iccid}</p>
				</div>
			</div>
			<div class="row">
				<div style="padding-bottom: 0.5rem; background-color: #eef0f0; text-align: center" class="col-xs-12">
					...
					<div style="margin: 0 auto 0.5vw 0; padding-left: 1rem; "
						class="col-xs-12">
							<div style="padding: 0 0 0 0; margin: 0.5rem auto 0 0"
								...
								<c:if test="${flowSize =='1G' }">
			                    	<img src="static/h5/images/1G40.png" style="height: 6rem">
		                        </c:if>
		                        <c:if test="${flowSize =='1G*4' }">
			                    	<img src="static/h5/images/1G480.png" style="height: 6rem">
		                        </c:if>
		                        <c:if test="${flowSize =='10G' }">
		                        	<img src="static/h5/images/10G350.png" style="height: 6rem">
		                  	   </c:if>
		                       <c:if test="${flowSize=='12G' }">
								<img src="static/h5/images/12G120.png" style="height: 6rem">
		                  	   </c:if>
		                  	   <c:if test="${not empty product}">
		                  	   	<img src='${product.goodsPic}' style="height: 6rem">
		                  	   </c:if>
							</div>
						<div style="padding: 0 0 0.2rem 0; margin-top:30px;"
							...
							<div style="color: #8c8c8c; margin: 0 auto;margin-left:60px;" class="row">
		                        ...
		                        <c:if test="${flowSize =='4G' }">
			                    	<div
										style="font-size: 3.2vw; padding-left: 17px; padding-right: 0; margin-right: 0; text-align: left;width:200px"
										class="col-xs-8">
										<h5 style="margin-bottom: 0px; font-size: 3.3vw;">1G*4流量包&nbsp;&nbsp;&nbsp;&nbsp;30天有效</h5>
									</div>
		                        </c:if>
		                        <c:if test="${flowSize =='10G' }">
		                        	<div
							   ...
							   <c:if test="${not empty product}">
										...
										style="font-size: 3.2vw; padding-left: 17px; padding-right: 0; margin-right: 0; text-align: left;width:200px"
										class="col-xs-8">
										<h5 style="margin-bottom: 0px; font-size: 3.3vw;">${product.goodsName}&nbsp;&nbsp;${product.goodsDesc}</h5>
									</div>
		                  	   </c:if>
		...
		<div style="background-color: #ffffff;">
			...
			<!-- <div style="border-bottom: 1px solid #dfe4e1;" class="row">
				...
				<div style="font-size: 3.3vw; padding-left: 0; padding-top: 0.8rem;"
					class="col-xs-3 ">支付宝支付</div>
				<div style="padding-top: 0.6rem; text-align: right" class="col-xs-4">
					<label>
					 <input type="radio" name="payWay" id="optionsRadios3" value="0" checked="checked">
					</label>
				</div>
			...
			<div style="border-bottom: 1px solid #dfe4e1;" class="row">
				...
				<div style="font-size: 3.3vw; padding-left: 0; padding-top: 1rem;"
					class="col-xs-3 "><fmt:message bundle='${pageScope.bundle}'  key='paying.through.Wechat' /></div>
				<div style="padding-top: 1rem; text-align: right" class="col-xs-4">
					<label> 
			...
			<div style="margin: 0; padding: 0; width: 100%; height: 50px;padding-right:0px !important;"
				...
				<div style="margin: 0vw; width: 100%; height: 50px" class="row">
					<div
						...
						<div style="float:left;color: red; text-align: left;margin-top: 1rem;width:50px;" >${payAmount}</div>
						<!-- class="col-xs-2" -->
					<div style="float:right;border-left: 1px solid #dfe4e1; background-color: #eb641a;height: 50px; margin-bottom: 1.5rem; text-align: center; padding: auto 0vw;"
						...
						<a href="javascript:void(0);"  onclick="$('#chargeForm').submit()" sytle="text-decorationnone;">
							<h5 style="font-size: 3.8vw; color: #ffffff; margin-left: 0px;line-height: 50px; ">
								<fmt:message bundle='${pageScope.bundle}'  key='Immediate.payment' />
							</h5>
						</a>
					</div>
				</div>
