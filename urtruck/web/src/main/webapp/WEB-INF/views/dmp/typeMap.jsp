...
<html>
<head>
<title><fmt:message bundle='${pageScope.bundle}'  key='Type.batch.address' /></title>
<base href="<%=basePath%>" />
<style type="text/css">
...
<body>
	<div id="l-map"></div>
	<input type="hidden" id="imeis" value="${imeis}"/>
...
$.ajax({
    type: "post",
    url: "<%=basePath %>deviceInfo/getBatchMap",
    data: 'imeis='+$("#imeis").val(),
    dataType: "json",
...
function createBatchMap(adds){
	...
	map.centerAndZoom(new BMap.Point(116.304988,40.060042), 13);
