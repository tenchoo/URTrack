...
<script type="text/javascript">
	...
	function saveRule() {
		var custId = ${balAlarmDto.chanCustId};
				...
				<div class="col-12 clearfix" style="margin-bottom: 50px;">
					...
					<div class="col-md-3 col-lg-3 mt20" style="width: 25%;">
						<input type="text" class="input-text" id="ruleName"
							name="ruleName" required value="${balAlarmDto.ruleName}">
					</div>
					...
					<div class="col-md-3 col-lg-3  mt20"
						...
						<input type="text" class="input-text" id="balFee" name="balFee"
							required value="${balAlarmDto.balRemain}">
					</div>
				</div>				
				<div class="col-12 clearfix" style="margin-bottom: 50px;">
					<div class="col-md-3 col-lg-3 mt20">
					...
					<div class="col-md-3 col-lg-3 mt20" style="width: 25%;">
						<input type="text" class="input-text" id="emaileId"
							name="emaileId" required value="${balAlarmDto.email}">
					</div>
					...
					<div class="col-md-3 col-lg-3  mt20"
						...
						<input type="text" class="input-text" id="telphoneId"
							name="telphoneId" required value="${balAlarmDto.telphone}">
					</div>
				</div>
				<div class="col-12 clearfix" style="margin-bottom: 50px;">
					<div class="col-md-3 col-lg-3 mt20">
					...
					<div class="col-md-3 col-lg-3  mt20"
						...
						<input type="text" class="input-text" id="cal" name="cal"
								required value="${balAlarmDto.cal}">
					</div>
				</div>
				<div class="col-12 clearfix" style="margin-bottom: 50px;">
					<div class="col-md-3 col-lg-3 mt20">
