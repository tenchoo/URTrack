...
public class StringUtil extends org.apache.commons.lang3.StringUtils{
	 ...
	 * @throws Exception
	 */
	public static String decodeCharset(String charSet) throws Exception {
	...
	public static void main(String[] args) {
		...
		System.out.println(lpad(8,1));
	}
	/**
	 * 功能描述：判断值所在的数组位置
	 * @author cuishuo
	 * @date 2016年6月18日 上午11:13:21
	 * @param @param s
	 * @param @param val
	 * @param @return 
	 * @return int
	 */
	public static int indextCheck(String[] s,String val){
		for(int i = 0;i<s.length;i++){
			if(!("".equals(val)||null==val)&&val.equals(s[i])){
				return i;
			}
		}
		return -1;
	 ...
	 * @return String[]
	 */
	public static String[] backString(String[] s,String val,String valn){
		if(null==s){
			return null;
		}
		String[] news = new String[s.length];
		
		int j = StringUtil.indextCheck(s, val);
		int l = StringUtil.indextCheck(s, valn);
		//未查到Jasper
		if(j==-1){
			return null;
		}
	 ...
	 * @return String[]
	 */
	public static String[] backStringcp(String[] s,String val,String valn){
		if(null==s){
			return null;
		}
		String[] news = new String[s.length];
		...
		for(int i = j+1, k=0;i<s.length;i++,k++){
			news[k] = s[i];
		}
