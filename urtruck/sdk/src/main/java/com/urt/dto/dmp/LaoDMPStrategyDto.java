...
public class LaoDMPStrategyDto implements Serializable {
	    private Long id;
		...
		public String toString() {
			return "LaoDMPStrategyDto [id=" + id + ", strategyName="
					+ strategyName + ", stategyComment=" + stategyComment
					+ ", strategyimpl=" + strategyimpl + ", delflag=" + delflag
					+ ", createtime=" + createtime + ", updatetime="
					+ updatetime + ", parameter1=" + parameter1
