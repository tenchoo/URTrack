 ...
 * 
 */
@Service("SendCancelLocationService")
public class SendCancelLocationService extends UnicomWsService {
	...
	public static void main(String[] args) throws SOAPException,
		...
		SOAPMessage soapMessage = client.call("89860616010010314686", "lmh-test-sendCancelLacation");
	...
	SOAPMessage createRequest(Object... args) throws SOAPException,
		...
		message.getMimeHeaders().addHeader(
				"SOAPAction",
				SoapConstant.DOMAIN
						+ SoapConstant.SOAPACTION_SENDCANCELLOCATION);
		SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
		Name name = envelope.createName("SendCancelLocationRequest",
	...
	public WsResponse parseMessage(SOAPMessage message) {
		SendCancelLocationResponse response = new SendCancelLocationResponse();
		try {
			SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
			Name parentName = envelope.createName("SendCancelLocationResponse",
					SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
