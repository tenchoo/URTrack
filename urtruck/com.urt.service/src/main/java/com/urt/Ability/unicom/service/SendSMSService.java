...
public class SendSMSService extends UnicomWsService {
	...
	public static void main(String[] args) throws SOAPException,
		...
		UnicomWsService client = new SendSMSService();
		client.init();
	...
	SOAPMessage createRequest(Object... args) throws SOAPException,
		...
		message.getMimeHeaders().addHeader("SOAPAction",
				SoapConstant.DOMAIN + SoapConstant.SOAPACTION_SENDSMS);
		SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
		Name name = envelope.createName("SendSMSRequest",
		...
		addElement(envelope, parentElement, "licenseKey", licenseKey,
				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
		addElement(envelope, parentElement, "sentToIccid", sentToIccid,
				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
...
//				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
	...
	public WsResponse parseMessage(SOAPMessage message) {
		...
		try {
			SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
			Name parentName = envelope.createName("SendSMSResponse",
					SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
			...
			String smsMsgId = getElementValue(envelope, parentElement, "smsMsgId");
