...
import com.urt.Ability.unicom.vo.SendBulkSMSToMsisdnResponse;
 ...
 * 
 */
@Service("SendBulkSMSToMsisdnService")
public class SendBulkSMSToMsisdnService extends UnicomWsService {
	...
	public static void main(String[] args) throws SOAPException,
		...
		UnicomWsService client = new SendBulkSMSToMsisdnService();
		client.init();
	...
	SOAPMessage createRequest(Object... args) throws SOAPException,
		...
		message.getMimeHeaders().addHeader("SOAPAction",
				SoapConstant.DOMAIN + SoapConstant.SOAPACTION_SENDBULKSMSTOMSISDN);
		SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
		Name name = envelope.createName("SendBulkSMSToMsisdnRequest",
		...
		addElement(envelope, parentElement, "licenseKey", licenseKey,
				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
		addElement(envelope, parentElement, "msisdnList", "msisdn",msisdnList,
				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
	...
	public WsResponse parseMessage(SOAPMessage message) {
		SendBulkSMSToMsisdnResponse response = new SendBulkSMSToMsisdnResponse();
		try {
			SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
			Name parentName = envelope.createName("SendBulkSMSToMsisdnResponse",
					SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
			...
			NodeList list = getElementList(envelope, parentElement, "smsMsgIdList");
