...
import com.urt.Ability.unicom.vo.SendSMSToMsisdnResponse;
 ...
 * 
 */
@Service("SendSMSToMsisdnService")
public class SendSMSToMsisdnService extends UnicomWsService {
	...
	public static void main(String[] args) throws SOAPException,
		...
		UnicomWsService client = new SendSMSToMsisdnService();
		client.init();
	...
	SOAPMessage createRequest(Object... args) throws SOAPException,
		...
		String sentToMsisdn = null;
		String messageText = null;
		String tpvp = null;
		String messageTextEncoding = null;// LITERAL, BASE64, LITERAL_IRA,
											// BASE64_IRA, LITERAL_BINARY,
											// BASE64_BINARY, LITERAL_GSM7,
											// BASE64_GSM7
		...
		message.getMimeHeaders().addHeader("SOAPAction",
				SoapConstant.DOMAIN + SoapConstant.SOAPACTION_SENDSMSTOMSISDN);
		SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
		Name name = envelope.createName("SendSMSToMsisdnRequest",
		...
		addElement(envelope, parentElement, "licenseKey", licenseKey,
				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
		addElement(envelope, parentElement, "sentToMsisdn", sentToMsisdn,
				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
		addElement(envelope, parentElement, "messageText", messageText,
				SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
		addElement(envelope, parentElement, "tpvp", tpvp, SoapConstant.PREFIX,
				SoapConstant.NAMESPACE_URI);
		addElement(envelope, parentElement, "messageTextEncoding",
				messageTextEncoding, SoapConstant.PREFIX,
				SoapConstant.NAMESPACE_URI);
	...
	public WsResponse parseMessage(SOAPMessage message) {
		SendSMSToMsisdnResponse response = new SendSMSToMsisdnResponse();
		try {
			SOAPEnvelope envelope = message.getSOAPPart().getEnvelope();
			Name parentName = envelope.createName("SendSMSToMsisdnResponse",
					SoapConstant.PREFIX, SoapConstant.NAMESPACE_URI);
			...
			String smsMsgId = getElementValue(envelope, parentElement,
					"smsMsgId");
			response.setSmsMsgId(smsMsgId);
