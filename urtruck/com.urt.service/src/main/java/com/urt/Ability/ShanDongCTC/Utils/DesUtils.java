...
public class DesUtils {
    ...
    public static void main(String[] args) {
    	...
    	String number = "8986031641201936634";     //查询号码
    	String user_id = "LenovoConnectSDCM";     //用户名
    	String password = "Lenovo.A1";    //密码
		...
		String sign = des.strEnc(naturalOrdering(arr),key1,key2,key3); //sign加密
