 ...
 * 
 */
@Service("EsimgetSessionInfoService")
public class EsimGetSessionInfoService extends UnicomWsService {
	...
	public static void main(String[] args) throws SOAPException,
		...
		UnicomWsService client = new EsimGetSessionInfoService();
		client.init();
		client.setUrl("https://api.10646.cn/ws/service/termina");
		client.setUsername("fuhp3AAA");
		client.setPasswd("abc123456");
		client.setLicenseKey("0efaf238-9229-4227-bcad-76d7ff130a9b");//89860616010057645125   89860116770002311843
		client.setVersion("1.0");

		SOAPMessage soapMessage = client.call("89860616010057645125",
				"lmh-test-SessionIfno");
