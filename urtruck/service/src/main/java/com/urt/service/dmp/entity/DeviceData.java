...
public class DeviceData implements Serializable {
	...
	//windows和Android共有信息
		...
		public String toString() {
			return "DeviceData [manufacturer=" + manufacturer
					+ ", batteryLevel=" + batteryLevel + ", elapsedTime="
					+ elapsedTime + ", model=" + model + ", board=" + board
					+ ", brand=" + brand + ", serial=" + serial + ", product="
					+ product + ", sdk_version=" + sdk_version + ", cpuId="
					+ cpuId + ", hadwareId=" + hadwareId + ", macAddress="
					+ macAddress + ", systemType=" + systemType
					...
					+ ", ip=" + ip + ", networkAdapterName="
					+ networkAdapterName + ", totlaInternalMemorySize="
					+ totlaInternalMemorySize + ", freeInternalMemorySize="
					+ freeInternalMemorySize + ", networkType=" + networkType
					+ "]";
		}
