...
/**
 * 查询资费计划详情，包括剩余流量，资费计划名称，队列位置等
 * @author liumh8
 *
 */
@Service("getTerminalRatingService")
...
//    	client.setUrl("https://api.10646.cn/ws/service/terminal");
    	...
    	client.setLicenseKey("2c800619-0416-47d6-858e-584c3e6b6c6a");//2c800619-0416-47d6-858e-584c3e6b6c6a
    
    //	for(int i = 0; i<100;i++){       8986061501000889177         89860616010010260715
    		SOAPMessage soapMessage = client.call("89860616020050733281","20170726105903");
