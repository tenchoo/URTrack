 ...
 * 
 */
@Service("EsimgetGlobalSimTransferStatusService")
public class EsimGetGlobalSimTransferStatusService extends UnicomWsService {
	@Override
	...
	public static void main(String[] args) throws SOAPException,
		...
		UnicomWsService client = new EsimGetGlobalSimTransferStatusService();
		client.init();
		...
		SOAPMessage soapMessage = client.call(
				"lmh-test-GlobalSimTransferStatus", "89860116770002311835");
	...
	@Override
	public GetGlobalSimTransferStatusResponse parseMessage(SOAPMessage message) {
