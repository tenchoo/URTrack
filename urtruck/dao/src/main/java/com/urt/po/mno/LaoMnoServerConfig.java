...
public class LaoMnoServerConfig implements Serializable {
    ...
    public Long getVisitLimitTimes() {
        return visitLimitTimes;
    }

    public void setVisitLimitTimes(Long visitLimitTimes) {
        this.visitLimitTimes = visitLimitTimes;
    }
