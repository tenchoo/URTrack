...
import com.urt.cmpp.util.MsgUtils;
...
public class MsgSubmit extends MsgHead {
	...
	public byte[] toByteArry(String lang){
		...
		try {
			if("EngLish".equals(lang)){
				...
				dous.writeChars(new String(this.msgContent,"GB2312"));
			}
			...
			/*ByteBuffer buf = ByteBuffer.allocate(this.msgLength);
			buf.put(new String(this.msgContent,"UTF8").getBytes());*/
			//dous.write(this.msgContent);//信息内容
			//dous.writeChars(new String(this.msgContent,"UTF8"));
			//System.out.print("1111111111"+new String(this.msgContent,"GB2312"));
			
			//dous.writeBytes(MsgUtils.getAscii(new String(this.msgContent,"GB2312")));
		...
		System.out.print(bous.toString());
	...
	public String toString() {
		return "MsgSubmit [msgId=" + msgId + ", pkTotal=" + pkTotal
				+ ", pkNumber=" + pkNumber + ", registeredDelivery="
				+ registeredDelivery + ", msgLevel=" + msgLevel
				+ ", serviceId=" + serviceId + ", feeUserType=" + feeUserType
				+ ", feeTerminalId=" + feeTerminalId + ", feeTerminalType="
				+ feeTerminalType + ", tpPId=" + tpPId + ", tpUdhi=" + tpUdhi
				+ ", msgFmt=" + msgFmt + ", msgSrc=" + msgSrc + ", feeType="
				+ feeType + ", feeCode=" + feeCode + ", valIdTime=" + valIdTime
				+ ", atTime=" + atTime + ", srcId=" + srcId + ", destUsrTl="
				+ destUsrTl + ", destTerminalId=" + destTerminalId
				+ ", destTerminalType=" + destTerminalType + ", msgLength="
				+ msgLength + ", msgContent=" + Arrays.toString(msgContent)
				+ ", linkID=" + linkID + "]";
	}
