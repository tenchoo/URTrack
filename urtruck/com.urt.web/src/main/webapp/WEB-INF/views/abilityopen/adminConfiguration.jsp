...
<script type="text/javascript">
	var dataTableObj = {
		...
		"sServerMethod":"post",
	    "bServerSide": true,
		"sAjaxSource" : "<%=basePath%>abilityOpen/appKeyList", /* 跳转url */
		...
		"columnDefs" : [
				...
				},
				{
					...
					"mRender" : function(data, type, full) {
						var date = DateFormat.tolongdata(data.UPDATE_DATE);
						return date;
					}
				},
				/* {
		...
		<form role="form">
				...
				<div class="col-md-4 col-lg-4 mt20">
					...
					<div class="tBox">
						<input type="text" class="input-text" value=""
							placeholder="<fmt:message bundle='${pageScope.bundle}'  key='Please.Input.Customer.Name' />" id="custName" name="custName">
					</div>
				</div>
			</div>
			<div class="mt20 clr" style="text-align: center;">
				<button id="search" type="button" class="btn btn-primary radius"
					onclick="sreach();">
					<i class="Hui-iconfont">&#xe665;</i><fmt:message bundle='${pageScope.bundle}'  key='Select.Customer' />
				</button>
			...
			<table id="example"
				...
				<thead>
					<tr class="zpTable">
						...
						<th width="90">AppKey</th>
						<th width="90"><fmt:message bundle='${pageScope.bundle}'  key='Creating.Time' /></th>
					</tr>
				</thead>
			</table>
		</div>
