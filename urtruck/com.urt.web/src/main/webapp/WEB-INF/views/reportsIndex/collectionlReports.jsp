...
<html>
<head>
<title><fmt:message bundle='${pageScope.bundle}'  key='cost.statement.query' /></title>
<base href="<%=basePath%>" />
<!-- css -->
...
<!-- 加载内容放这里 -->
            <div class="tableBox">
               ...
               <div class="tableTit">
                     	<fmt:message bundle='${pageScope.bundle}'  key='cost.statement' />
                </div>
             <table class="overflow-y" id="idData">
             	<thead>
             		<tr>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='region' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='sales' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Corporate.customer' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Is.it.a.channel' /></th>
	             		...
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Sales.unit.price' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Sales.volume.(number.of.users)' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Actual.amount.(yuan)' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Legal.entity' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Final.customer.name' /></th>
	             		<th><fmt:message bundle='${pageScope.bundle}'  key='Customer' /> logo</th>
	             	</tr>
             	</thead>
             	<tbody id="tatbody">
             	</tbody>	
