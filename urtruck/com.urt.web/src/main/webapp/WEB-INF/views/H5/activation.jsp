    ...
    <script type="text/javascript">
        $(function(){
        	var iccidInput=$('[name="iccid"]');
             var privatekeyInput=$("#privatekey input");
             var error_box=$(".error-box");
             var privateKeyError=$(".privatekeyError");
             var usernameInput=$("#userame input");
            ...
            $("#activeBtn").click(function(){
                ...
                if(!ss){
                    alert("<fmt:message bundle='${pageScope.bundle}'  key='Please.agree.to.enter.into.the.network.agreement' />");
                    return;
                }
                //iccid验证
                ...
                if(!mache.test(iccid)){
                    ...
                    error_box.html("<fmt:message bundle='${pageScope.bundle}'  key='Please.enter.the.correct.device.number' />");
                    errorFlag=true;
                }
                //卡密验证
                var privatekey=privatekeyInput.charValidation();
                var mache=/^[0-9a-zA-Z]{5,}[0-9a-zA-Z]+$/;
                if(!mache.test(privatekey)){
                    privateKeyError.css({
                        "display":"inline"
                    })
                    privateKeyError.html("<fmt:message bundle='${pageScope.bundle}'  key='Please.enter.the.correct.card.password' />");
                    errorFlag=true;
                }
                //姓名验证
                ...
                if(deviceType==''){
                    deviceTypeErrorInput.html("<fmt:message bundle='${pageScope.bundle}'  key='Please.select.the.activation.device.types' />");
                ...
                var data={'iccid':iccid,'privatekey':privatekey,'realname':username,'idnum':idcardValue};
                ...
                $.ajax({
                    type:"post",
                    url:"/deviceActivation/activeService",
                    data:data,
                    cache: false,
                    success:function(data){
                        ...
                        switch (statusCode) {
                            case 0:
                                ...
                                break;
                            case 1:
                            	window.location.href="<%=basePath%>deviceActivation/activeSuccess";
                            	break;
                            case 2:
                                error_box.css({
                                    "display":"inline"
            ...
            privatekeyInput.focus(function(){
...
<div style=" font-size:3.8vw; ">
    ...
    <div  style="width: 100%;" class="row">
        ...
        <div style="font-size: 4vw; padding-top:2rem;padding-bottom:2rem;text-align: center;border-bottom:1px  solid #dfe4e1" class="col-xs-11 col-xs-offset-1 "><fmt:message bundle='${pageScope.bundle}'  key='Device.activation' /></div>
    </div>
    <div  style="width: 100%;" class="row">
             ...
             <form>
                <div style="padding-top:18px;padding-bottom:16px;border-bottom:1px  solid #dfe4e1" class="col-xs-11 col-xs-offset-1 ">
                   <div class="row">
                       ...
                       <div style="" class="col-xs-8 "><input style="width: 100%;border: hidden;background: none;" type="text" name="iccid">  </div>
                   </div>
                    <div class="row">
                ...
                <div style="padding-top:18px;padding-bottom:16px;border-bottom:1px  solid #dfe4e1" class="col-xs-11 col-xs-offset-1 ">
                    <div class="row">
                        ...
                        <div style=""id="userame" class="col-xs-8 "><input style="width: 100%;border: hidden;background: none;" type="text" id="userame">  </div>
                    </div>
                    <div class="row">
                        <div style="padding-top: 5px; font-size: 3.5vw;color:  #e2231a;" class="userameError col-xs-8 col-xs-offset-2"><fmt:message bundle='${pageScope.bundle}'  key='The.name.must.be.Chinese' /> </div>
                    </div>
                </div>
                <div style="padding-top:18px;padding-bottom:16px;border-bottom:1px  solid #dfe4e1" class="col-xs-11 col-xs-offset-1 ">
                    <div class="row">
                    ...
                    <div class="row">
                        <div style="padding-top: 5px; font-size: 3.5vw;color:  #e2231a;" class="idcardError col-xs-8 col-xs-offset-2"> <fmt:message bundle='${pageScope.bundle}'  key='Please.enter.the.correct.id.number' /></div>
                    </div>
                </div>
                <div style="padding-top:18px;padding-bottom:16px;border-bottom:1px  solid #dfe4e1" class="col-xs-11 col-xs-offset-1 ">
                    <div class="row">
                        ...
                        <div style="" class="col-xs-8 ">
                            <div class="form-text">
                                <select style="border: none; width: 100%;background: none;" id="deviceType">
                                    <option style="border: none"value="">-<fmt:message bundle='${pageScope.bundle}'  key='please.select.activation.devices' />-</option>
        ...
        <div style="padding-top:18px;padding-bottom:16px;border-bottom:1px  solid #dfe4e1" class="col-xs-11 col-xs-offset-1 ">
            <div class="row">
                ...
                <a href="<%=basePath%>deviceActivation/protocol">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div style="border-top: none"class="modal-footer">
                    <div class="row">
                        <div class="col-xs-5">
                            <button style="color:#ffffff;border-radius: 10px;text-align: center;background-color: #fa9148; " type="button" class="btn " onclick="window.location.href='<%=basePath%>queryService/index'" ><fmt:message bundle='${pageScope.bundle}'  key='View.traffic' /></button>
                        </div>
                        <div class="col-xs-6">
                            <button style="color:#ffffff;border-radius: 10px;text-align: center;background-color: #fa9148; " type="button" class="btn " onclick="window.location.href='<%=basePath%>h5/index'" ><fmt:message bundle='${pageScope.bundle}'  key='Home' /></button>
                        </div>
                    </div>
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div style="text-align: center;padding: ;width: 100%" class="container">
            <button style="font-size:4vw;width: 70vw;margin: 0.8rem auto; color:#ffffff;border-radius: 10px;text-align: center;background-color: #fa9148; " type="button" class="btn " id="activeBtn">
               <fmt:message bundle='${pageScope.bundle}'  key='activate.now' /></button><!-- data-toggle="modal" data-target="#myModal" -->
        </div>
    </nav>
</div>
<script type="text/javascript">
