...
<body>
	...
	<div class="pd-20">
		<form role="form">
			<div class="oh row">
				<div class="col-md-4 col-lg-4 mt20">
					<label for="name" class="font12 fl">联系人：</label>
					<div class="tBox">
						<input type="text" class="input-text" value=""
							placeholder="请输入客户名称" id="contactName" name="contactName">
		...
		<div class="fr mtb20">
			<a href="javascript:;" onclick="add_concat('添加联系人','${ctx}/cust/createConcat/${requestScope.custId}','800','550')" class="btn btn-primary radius">
			  			        	 ...
			  			        	 "mRender": function ( data, type, full ) {
			  			        		 //<a title=\"删除\" href="javascript:;" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>
			  			                	return  '<a title=\"编辑\" href="javaScript:toUpdate('+data.contactId+');" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a> '
			  			                	 +'<a title=\"删除\" href="javascript:delConcat('+data.contactId+');" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i>'
			  			                 }
			  			         },
			                  ],	           
			  "sScrollX": "100%",
