...
<body><div style=" font-size: 3.8vw;" >
    ...
    <div style="margin-top: 3rem; text-align: center" class="">
        ...
        <button style="font-size:5vw;height: 40px;width:80vw;color:#ffffff;border-radius: 10px;text-align: center;background-color: #fa9148; " type="button" class="btn " onclick="window.location.href='<%=basePath%>glaH5AppQuery/index?iccid=${iccid}' "><fmt:message bundle='${pageScope.bundle}'  key='View.traffic' /></button>
