...
<body>
	<div style="background-color: #f4f3f9; font-size: 3.8vw;">
		...
		<div style="margin-bottom: 2vw;width: 100vm ;margin-left:0;margin-right:0" class="row">
			<img src="static/h5/images/bjtp.jpg" class="img-responsive">
		</div>
		<div
			...
			<div style="width: 100vw" class="row">
				<div class="col-xs-5 col-xs-offset-2">
					<button
						...
						type="button" class="btn " onclick="window.location.href='<%=basePath%>glaH5AppQuery/index'"><fmt:message bundle='${pageScope.bundle}'  key='View.traffic' /></button>
				</div>
				<div class="col-xs-5">
					<button
						style="border-radius: 10px; text-align: center; border: solid 1px black; background-color: #ffffff;"
						type="button" class="btn " onclick="window.location.href='<%=basePath%>glaH5App/index'"><fmt:message bundle='${pageScope.bundle}'  key='Home' /></button>
				</div>
			</div>
		</div>
