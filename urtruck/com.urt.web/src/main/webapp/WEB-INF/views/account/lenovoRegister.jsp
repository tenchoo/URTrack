...
<body class="">
			...
			<div class="row myrow">
				...
				<div class="col-lg-5 col-md-5 leftContent">
					...
					<form id="inputForm" action="${ctx}/register" method="post"
						...
						<input type="hideen" name="relatedId" value="${relatedId}">
						...
						<lable id="loginNameMsg" class="font12 hint"><!-- 登录名由6-20个字母数字组合 --></lable>
						...
						<input type="submit" class="buttonOne text-center" value="注册">
					</form>
	...
	function refreshCaptcha() {
		debugger;
		$("#captchaImg").attr("src", "${ctx}/servlet/captchaCode?t=" + Math.random());
	}
	</script>
	</div>
</body>
