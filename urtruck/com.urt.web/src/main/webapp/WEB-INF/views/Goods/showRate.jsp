...
<body>
			<div class="mt-20">
				...
				<tr class="zpTable">
			<th >ICCID</th>
			<th ><fmt:message bundle='${pageScope.bundle}'  key='Residual.trafffic' />(M)</th>
				</tr>
		<c:forEach items="${resulList }" var="rate">
		<tr>
			<td><span style="font-size: 12px;">${rate.iccid}</span></td>
			<td><span style="font-size: 12px;">${rate.dataRemaining}</span></td>
