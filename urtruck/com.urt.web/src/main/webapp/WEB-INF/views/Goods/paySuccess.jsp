...
<html>
<head>
	<title><fmt:message bundle='${pageScope.bundle}'  key='Recharge.success.page' /></title>
	<base href="<%=basePath%>" />
...
<body>
	<h1 align="center"><fmt:message bundle='${pageScope.bundle}'  key='Payment.successfully' />！</h1>
</body>
</html>
