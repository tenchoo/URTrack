...
<title><fmt:message bundle='${pageScope.bundle}'  key='Product.add.page' /></title>
...
<body>
	<div class="seconSec">
		...
		<form method="post" class="form form-horizontal" id="form"
			...
			<div class="col-12 mt20">
				<label class="fl langWidth"> <span
					class="colorRed smallStar">*</span> <span class="font12"><fmt:message bundle='${pageScope.bundle}'  key='Please.upload.pictures' />:</span>
				</label>
				<div class="formControls langMl zpInput">
					<div class="uldImg fl">
			...
			<div class="col-12 mt20">
				<label class="fl langWidth"> <span
					class="colorRed smallStar">*</span> <span class="font12"><fmt:message bundle='${pageScope.bundle}'  key='Standard.price' />:</span>
				</label>
				<div class="formControls langMl zpInput">
...
$(function(){
	$.post("<%=request.getContextPath()%>/operators/findOperators",
		...
		function check() {
			...
			var goodsNameValue = window.document.getElementById("goodsId").value;
